...
### Web Server Live Dashbord in Node.js

![Box Sensors Live Dashboard](pictures/WebServerDashboard.png)

*Box Sensors Live Dashboard — real-time match telemetry and scoring from the boxing sensor system.*

**Live Dashboard:** https://boxing-dashboard.ndimitrakarakos.gr/  
*Server-hosted web dashboard for real-time match monitoring (scores, rounds, and event feed).*
