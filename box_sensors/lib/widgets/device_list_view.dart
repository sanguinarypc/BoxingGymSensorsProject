      ...
      slivers: [
        SliverList(
          delegate: SliverChildBuilderDelegate((context, index) {
            ...
            final textColor = deviceName == DeviceConfig.redBoxer
                ? Colors.red
                : deviceName == DeviceConfig.blueBoxer
                ? Colors.blue
                : deviceName == DeviceConfig.boxerServer
                ? Colors.green
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          if (connectionNotifiers.containsKey(deviceName))
                            ValueListenableBuilder<bool>(
                              valueListenable: connectionNotifiers[deviceName]!,
                              builder: (context, isConn, child) {
                                if (!isConn || !isDeviceConnected(deviceName)) {
                                  return const SizedBox.shrink();
                                }
                                return ElevatedButton(
                                  onPressed: () => onDisconnect(deviceName),
