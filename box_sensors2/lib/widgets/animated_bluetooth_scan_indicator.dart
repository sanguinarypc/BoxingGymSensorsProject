...
// class _AnimatedBluetoothScanIndicatorState extends State<AnimatedBluetoothScanIndicator>
//     with SingleTickerProviderStateMixin {
//   late final AnimationController _controller;
//   late final Animation<double> _scaleAnimation;
...
//   @override
//   Widget build(BuildContext context) {
//     // Set the circle color based on scanning state.
//     final Color circleColor = widget.isScanning ? Colors.green : Colors.red;
...
//           child: Container(
//             padding: const EdgeInsets.all(2), // Outer padding for a border effect.
//             decoration: const BoxDecoration(
//               shape: BoxShape.circle,
//               color: Colors.black, // Border color for the indicator.
//             ),
//             child: Icon(
//               Icons.circle,
//               color: circleColor,
