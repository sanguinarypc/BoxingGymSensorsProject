...
import '../widgets/adaptive_safe_bottom.dart'; // <<— NEW import
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // ⬇️ FIX: keep your buttons exactly the same, just wrapped so that
          // on Android 15 they sit above the system 3-button nav bar.
          AdaptiveSafeBottom(
            // keep transparent so the visual look remains identical
